...
DEFAULT_SETTINGS = {
    ...
    "coder_models": ["google/gemini-3.5-flash", "google/gemini-3.6-flash", "google/gemini-3-flash", "openai/gpt-4o", "anthropic/claude-3-5-sonnet-latest"],
    "verifier_models": ["google/gemini-3.5-flash-lite", "google/gemini-3.5-flash", "google/gemini-3.1-flash-lite", "openai/gpt-4o-mini"],
    "reviewer_models": ["google/gemini-3.5-flash", "google/gemini-3.6-flash", "google/gemini-3-flash", "openai/gpt-4o-mini"],

...
DEFAULT_SETTINGS = {
    "planner_models": ["google/gemini-1.5-flash", "openai/gpt-4o-mini", "openrouter/free"],
    "coder_models": ["google/gemini-1.5-flash", "openai/gpt-4o", "anthropic/claude-3-5-sonnet-latest"],
    "verifier_models": ["google/gemini-1.5-flash", "openai/gpt-4o-mini"],
    "reviewer_models": ["google/gemini-1.5-flash", "openai/gpt-4o-mini"],
    "summary_models": ["google/gemini-1.5-flash", "openai/gpt-4o-mini"],

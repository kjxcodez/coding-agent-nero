        ...
        for iteration in range(1, self._max_iter + 1):
            ...
            if not response.tool_calls:
                if content.strip().startswith(self.DONE_SIGNAL):
                    ...
                    current_step_idx = self._apply_step_signals(
                        content, plan, current_step_idx
                    )
